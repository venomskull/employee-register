...
// import defaultImageSrc from '../img/user.png';


const defaultImageSrc = '/img/avatar.jpg';
                ...
                <div className="card">
                    ...
                    <div className="card-body">
                        <div className="form-group">
                            <input className={"form-control-file" + applyErrorClass('imageSrc')} type="file" accept="image/*" 
